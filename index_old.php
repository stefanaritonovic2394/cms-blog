            ...
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="post.php?p_id=<?php echo $post_id; ?>" class="btn btn-primary">Pročitaj Više &rarr;</a>
                    </div>
                    <div class="card-footer text-muted">
                        Objavio <a href="author_posts.php?author=<?php echo $post_author; ?>&p_id=<?php echo $post_id; ?>"><?php echo $post_author; ?></a>
